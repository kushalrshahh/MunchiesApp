...
public class FragmentSimpleLoginButton extends Fragment {
    ...
    private FacebookCallback<LoginResult> mFacebookCallback = new FacebookCallback<LoginResult>() {
        ...
        public void onSuccess(LoginResult loginResult) {
            ...
            if(AccessToken.getCurrentAccessToken()!=null)
                translate_button.setVisibility(viewRestaurants.VISIBLE);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
         ...
         viewRestaurants =inflater.inflate(R.layout.fragment_simple_login_button, container, false);
        translate_button = (Button) viewRestaurants.findViewById(R.id.buttonViewRestaurants);
        if (profile != null) {
            Log.d("access1", "access1");
        ...
        translate_button.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(getActivity(), PlaceCompleteMainActivity.class);
    ...
    public void onStop() {
        super.onStop();
        translate_button.setVisibility(viewRestaurants.INVISIBLE);
